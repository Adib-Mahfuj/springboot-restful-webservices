...
public class UserServiceImpl implements UserService {
    ...
    public UserDto getUserById(Long userId) {
        // Optional<User> is used to avoid errors when the user is not found in the database.
        // `findById()` returns an `Optional<User>` type, and you use `.get()` to retrieve the value inside the Optional if it exists.
    ...
    public List<UserDto> getAllUsers() {
        ...
        // Use a lambda expression to map each 'User' object to a 'UserDto' object using modelMapper
